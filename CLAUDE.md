...
5. Treat repo documents as the source of truth over Nowledge Memory, Working Memory, or raw Threads.
...
- Never write cookies, tokens, passwords, API keys, private keys, browser profile contents, full session configs, or sensitive screenshot contents into memory docs, Nowledge Memory, or chat.
